...
var DivisionByZero = function() {
	return /* @__PURE__ */ new Error("Division by Zero");
};
var InvalidParameter = function() {
	return /* @__PURE__ */ new Error("Invalid argument");
};
var NonIntegerParameter = function() {
	return /* @__PURE__ */ new Error("Parameters must be integer");
};
Fraction.prototype = {
	"s": C_ONE,
	"n": C_ZERO,
	...
	**/
	"mod": function(a, b) {
		if (a === void 0) return newFraction(this["s"] * this["n"] % this["d"], C_ONE);
		parse(a, b);
	...
	*/
	"pow": function(a, b) {
		parse(a, b);
		if (P["d"] === C_ONE) if (P["s"] < C_ZERO) return newFraction((this["s"] * this["d"]) ** P["n"], this["n"] ** P["n"]);
	...
	"log": function(a, b) {
		...
		for (const prime in allPrimes) {
			...
			if (baseExponent === C_ZERO) {
				if (numberExponent !== C_ZERO) return null;
				continue;
			}
			...
			if (retN === null && retD === null) {
				retN = curN;
				retD = curD;
			} else if (curN * retD !== retN * curD) return null;
		}
