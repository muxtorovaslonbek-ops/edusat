...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CgU9iuS8.mjs");
...
var ROUTER_BASEPATH = "courses/matematika";
var SERVER_FN_BASE = "/courses/matematika/_serverFn/";
